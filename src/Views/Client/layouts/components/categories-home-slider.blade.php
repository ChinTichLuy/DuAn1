<div class="banners-container mb-2">
    <div class="banners-slider owl-carousel owl-theme" data-owl-options="{
        ...
        <div class="banner banner1 banner-sm-vw d-flex align-items-center appear-animate" style="background-color: #ccc;"
            data-animation-name="fadeInLeftShorter" data-animation-delay="500">
            <figure class="w-100">
                <img src="{{ asset('theme/client/images/demoes/demo4/banners/banner-1.jpg') }}" alt="banner"
        ...
        <div class="banner banner2 banner-sm-vw text-uppercase d-flex align-items-center appear-animate"
            ...
            <figure class="w-100">
                <img src="{{ asset('theme/client/images/demoes/demo4/banners/banner-2.jpg') }}"
        ...
        <div class="banner banner3 banner-sm-vw d-flex align-items-center appear-animate"
            ...
            <figure class="w-100">
                <img src="{{ asset('theme/client/images/demoes/demo4/banners/banner-3.jpg') }}" alt="banner"
                    width="380" height="175" />
            </figure>
