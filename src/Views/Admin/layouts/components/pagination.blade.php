        ...
        <ul class="pagination">
            ...
            @else
                <li class="paginate_button page-item previous" id="customerList-table_previous">
                    <a href="{{ routeAdmin("{$url}" . $page - 1) }}" aria-controls="customerList-table"
                        aria-disabled="true" role="link" data-dt-idx="previous" tabindex="-1" class="page-link">
                        <i class="mdi mdi-chevron-left"></i>
                    </a>
                </li>
            @endif
            ...
            @if ($page == $totalPage)
                <li class="paginate_button page-item disabled" id="customerList-table_next">
                    <a href="#" aria-controls="customerList-table" role="link" data-dt-idx="next"
            ...
            @else
                <li class="paginate_button page-item" id="customerList-table_next">
                    <a href="{{ routeAdmin("{$url}" . ++$page) }}" aria-controls="customerList-table" role="link"
